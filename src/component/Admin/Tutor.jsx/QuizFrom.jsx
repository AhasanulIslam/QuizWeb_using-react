...
//   })
  ...
  const handleFromSubmit = async (event) => {
    ...
    await axios
      .post(
        "https://nano-quiz-api.herokuapp.com/quiz/create-quiz",
        ggwp,
        {
          headers: {
    ...
    <div className="container">
      <div className=" app-wrapper">
        ...
        <form className="from-wrapper">
          ...
          <div className="email">
            <label className="label">Total Qestion</label>
            <input
              className="input"
              type="number"
              name="total_question"
          ...
          <div className="email">
            <label className="label">Incorrect Options1</label>
            <input
              className="input"
              type="text"
              name="incorrect1"
              ...
              onChange={handleChange}
            />
            {errors.incorrect1 && <p className="error">{errors.incorrect1}</p>}
          </div>
          ...
          <div className="email">
            <label className="label">Incorrect Options2</label>
            <input
              className="input"
              type="text"
              name="incorrect2"
              ...
              onChange={handleChange}
            />
            {errors.incorrect2 && <p className="error">{errors.incorrect2}</p>}
          </div>
          ...
          <div className="email">
            <label className="label">Incorrect Options3</label>
            <input
              className="input"
              type="text"
              name="incorrect3"
              ...
              onChange={handleChange}
            />
            {errors.incorrect3 && <p className="error">{errors.incorrect3}</p>}
          </div>
          ...
          <div className="email">
            <label className="label">Incorrect Options4</label>
            <input
              className="input"
              type="text"
              name="incorrect4"
              ...
              onChange={handleChange}
            />
            {errors.incorrect4 && <p className="error">{errors.incorrect4}</p>}
          </div>
          ...
          <div className="email">
            <label className="label">Incorrect Options5</label>
            <input
              className="input"
              type="text"
              name="incorrect5"
              ...
              onChange={handleChange}
            />
            {errors.incorrect5 && <p className="error">{errors.incorrect5}</p>}
          </div>

          <div className="email">
            <label className="label">Answer5</label>
            <input
              className="input"
              type="text"
              name="answer5"
          ...
          <div>
            <button className="submit" onClick={handleFromSubmit}>
              Create Quiz
            </button>
          </div>
        </form>
